...
public class SimpleNode implements Node {
	private static final Log log = LogFactory.getLog(SimpleNode.class);
  ...
  public SimpleNode(SimpleParser p, int i) {
    this(i);
    parser = p;
  }
  ...
  @Override
public String toString() { return SimpleParserTreeConstants.jjtNodeName[id]; }
